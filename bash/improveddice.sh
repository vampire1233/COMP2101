...
#store the number of sides of dice in a variable
sides=6
totaldice=2

#store the bias in a variable
bais=1

# roll the dice and save the results
die1=$(( RANDOM % $sides + $bais ))
die2=$(( RANDOM % $sides + $bais ))
# sum up the rolls
sum=$(( die1 + die2 ))

#count average of the dice
avr=$((sum / totaldice))

# display the results
echo "Rolled $die1, $die2 the sum of this number is: $sum And the average is: $avr"
